...
void C_ConfigManager::setup()
{
	...
	setup_item(&g_cfg.antiaim.pitch_type, 0, crypt_str("Antiaim.pitch"));
	setup_item(&g_cfg.antiaim.yaw_type, 0, crypt_str("Antiaim.fake_lag_randomize"));
	setup_item(&g_cfg.antiaim.desync_options, 4, crypt_str("Antiaim.desync_options"));
	setup_item(&g_cfg.antiaim.desync_type, 0, crypt_str("Antiaim.desync_type"));
	...
	setup_item(&g_cfg.antiaim.desync_angle, 0, crypt_str("Antiaim.desync_angle"));
	setup_item(&g_cfg.antiaim.break_lby, false, crypt_str("Antiaim.lby_breaker"));
	setup_item(&g_cfg.antiaim.fake_yaw, false, crypt_str("Antiaim.fake_yaw"));
	setup_item(&g_cfg.antiaim.inverter, false, crypt_str("Antiaim.inverter"));
	setup_item(&g_cfg.antiaim.yaw_offset, 0, crypt_str("Antiaim.yaw_offset"));
	setup_item(&g_cfg.antiaim.yaw_jitter, 0, crypt_str("Antiaim.jitter_offset"));
	setup_item(&g_cfg.antiaim.invert_desync_angle, 0, crypt_str("Antiaim.invert_desync_angle"));
	setup_item(&g_cfg.antiaim.desync_onshot, 0, crypt_str("Antiaim.desync_on_shot"));
	setup_item(&g_cfg.antiaim.lby_mode, 0, crypt_str("Antiaim.lby_mode"));
	setup_item(&g_cfg.antiaim.freestand_desync, 0, crypt_str("Antiaim.freestand_desync"));
	setup_item(&g_cfg.antiaim.yaw_modifier, 0, crypt_str("Antiaim.yaw_modifier"));
	setup_item(&g_cfg.antiaim.yaw_base, 0, crypt_str("Antiaim.yaw_base"));
	...
	setup_item(&g_cfg.antiaim.fakelag_amount, 0, crypt_str("Antiaim.fake_lag_limit"));
	setup_item(&g_cfg.antiaim.triggers_fakelag_amount, 0, crypt_str("Antiaim.triggers_fakelag_limit"));
	...
	setup_item(&g_cfg.esp.molotov_wireframe, false, crypt_str("Esp.molotov_wireframe"));
	...
	setup_item(&g_cfg.esp.arms_double_material_type, 0, crypt_str("Esp.arms_double_material_type"));
	...
	setup_item(&g_cfg.esp.weapon_double_material_type, 0, crypt_str("Esp.weapon_double_material_type"));
	...
	setup_item(&g_cfg.misc.keybinds_x, false, crypt_str("Misc.keybinds_x"));
	setup_item(&g_cfg.misc.keybinds_y, false, crypt_str("Misc.keybinds_y"));
	...
	setup_item(&g_cfg.misc.turn_speed, 1.0, crypt_str("Misc.autostrafe_turn_speed"));
	...
	setup_item(&g_cfg.misc.debuglogs, false, crypt_str("Misc.debuglogs"));
	...
	setup_item(&g_cfg.menu.menu_theme, Color(15, 15, 15), crypt_str("Menu.menu_color"));
	setup_item(&g_cfg.menu.watermark, false, crypt_str("Menu.watermark"));
	setup_item(&g_cfg.menu.windows, 2, crypt_str("Menu.windows"));
