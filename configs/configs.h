...
struct Config 
{
	...
	struct AntiAim_t 
	{
		...
		int yaw_modifier;
		int lby_mode;
		int freestand_desync;
		int desync_onshot;
		int desync_angle;
		int invert_desync_angle;
		bool break_lby;
		std::vector <int> antiaim_conditions;
		std::vector <int> desync_options;

		bool enable_fake_angles;
		bool fake_yaw;
	...
	struct Visuals_t
	{
		...
		int weapon_double_material_type;
